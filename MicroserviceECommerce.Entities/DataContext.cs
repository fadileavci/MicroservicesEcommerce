namespace MicroserviceECommerce.Entities
{
	...
	public partial class DataContext : DbContext
	{
		...
		public virtual DbSet<Categorys> Categories { get; set; }
		...
		public virtual DbSet<Territorys> Territories { get; set; }
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Musterilers>()
			...
			modelBuilder.Entity<Territorys>()
